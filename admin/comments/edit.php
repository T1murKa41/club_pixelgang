...
<body>
    ...
    <div class="container">
        <div class="row">
            ...
            <?php include_once '../../application/include/sidebar-admin.php' ?>
                ...
                <div class="row add-post">
                    <form action="edit.php" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-floating ">
                            <input name="title" type="text" class="form-control" id="floatingInput" placeholder="Заголовок" value="<?= $post['title'] ?>">
                            <label for="floatingInput">Заголовок</label>
                        </div>

                        <div class="form-floating">
                            <textarea name="content" class="form-control" placeholder="Текст" id="editor"><?= $post['content'] ?></textarea>
                        </div>
                        <br>
                        ...
                        <div class="col-auto">
                            <button name="edit_post" type="submit" class="btn btn-outline-info">Обновить</button>
                        </div>
                    </form>
                </div>
            </div>
