                    ...
                    <table class="table table-hover table-sm">
                        <thead>
                            <tr>
                                ...
                                <th scope="col" class="article">Текст</th>
                        ...
                        <tbody>
                            <?php foreach ($commentsForAdm as $key => $comment) : ?>
                                <tr>
                                    ...
                                    <td><?= $comment['email']; ?></td>
                                    <td><a href="edit.php?delete_id=<?= $comment['id']; ?>">Удалить</a></td>
                                    <?php if ($comment['status']) : ?>
                                        <td class="delete"><a href="edit.php?publish=0&pub_id=<?= $comment['id']; ?>">Убрать публикацию</a></td>
                                    <?php else : ?>
                                        <td class="delete"><a href="edit.php?publish=1&pub_id=<?= $comment['id']; ?>">Опубликовать</a></td>
                                    <?php endif; ?>
                                </tr>
                            <?php endforeach; ?>
                        </tbody>
